...
from ai_assistant.persistence.db import session_scope
from ai_assistant.persistence.models import AssistAudit

logger = logging.getLogger(__name__)


class AuditSink(Protocol):
    """Interface consumed by :class:`ai_assistant.services.assist_service.AssistService`."""
