...
from ai_assistant.api.routes import assist, health
from ai_assistant.config import get_settings
from ai_assistant.middleware.correlation import CorrelationIdMiddleware
from ai_assistant.persistence.audit import configure_audit_sink
from ai_assistant.persistence.db import init_database, shutdown_database
from ai_assistant.search.runtime import init_retrieval, shutdown_retrieval
...
# ASGI app for Uvicorn: ``uvicorn ai_assistant.main:app``
app = create_app()
