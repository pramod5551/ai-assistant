"""Construct a concrete :class:`~ai_assistant.embeddings.Embedder` from resolved settings."""

from __future__ import annotations

from ai_assistant.config import Settings
from ai_assistant.embeddings import Embedder
from ai_assistant.embeddings.fastembed_backend import FastembedEmbedder
from ai_assistant.embeddings.http_openai import OpenAICompatibleEmbedder


def create_embedder(settings: Settings) -> Embedder:
    """Dispatch on :meth:`ai_assistant.config.Settings.resolved_embedding_backend`.
