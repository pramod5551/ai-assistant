...
Bridges HTTP facades to the orchestration :class:`~ai_assistant.orchestration.contracts.AssistantPipeline`
...
from ai_assistant.orchestration.rag_graph import get_pipeline
from ai_assistant.persistence.audit import get_audit_sink
