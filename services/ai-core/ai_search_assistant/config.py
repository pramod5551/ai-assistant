...
class Settings(BaseSettings):
    ...
    **Vectors:** in-process stub or Qdrant (plug-in pattern for other stores in code).
    ...
    app_name: str = "ai-search-assistant-core"
    ...
    seed_vector_collection_on_startup: bool = Field(
        default=False,
        description="Reserved; no bundled seed data is shipped. Ingest documents via the UI.",
        validation_alias=AliasChoices(
    ...
    ingest_max_upload_bytes: int = Field(
        ...
        ge=1024,
        le=52_428_800,
        description="Max raw bytes per uploaded file (default 10 MiB).",
        validation_alias=AliasChoices(
    ...
    otel_service_name: str = Field(
        default="ai-search-assistant-core",
